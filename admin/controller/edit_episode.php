...
$statment = $connect->prepare(
	"UPDATE episodes SET episode_title = :episode_title, episode_description = :episode_description, episode_serie = :episode_serie, episode_link = :episode_link, episode_status = :episode_status, episode_image = :episode_image WHERE episode_id = :episode_id"
	);
