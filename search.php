...
$sqlQuery = "(SELECT movie_id as id, movie_slug as slug, movie_image as image, movie_title as title, movie_year as year, 'movie' as type FROM movies WHERE movie_title LIKE '%" . $queryGet . "%' OR movie_stars LIKE '%" . $queryGet . "%') UNION (SELECT serie_id as id, serie_slug as slug, serie_image as image, serie_title as title, serie_year as year, 'serie' as type FROM series WHERE serie_title LIKE '%" . $queryGet . "%' OR serie_stars LIKE '%" . $queryGet . "%')";
